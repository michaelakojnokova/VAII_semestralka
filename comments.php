...
function show_comments($comments, $parent_id = -1) {
    ...
    if ($parent_id != -1) {
        ...
        $array_column = array_column($comments, 'submit_date');
        array_multisort($array_column, SORT_ASC, $comments);
    }
...
?> <!--KOMENTOVACI WRITE COMMENT BUTTON-->
<div class="comment_header col-lg-8 col-md-10 mx-auto">
