    ...
    <div class="container">
        <div class="col-sm-16">
            ...
            <div id="container14">
                ...
                <p id="pAboutMe">Hi ! My name is Peyton. I started this blog on a whim in the fall of 2010. I was
                    frequently asked for my
            ...
            <section class="mb-4">
                ...
                <p id="Suggestion" class="text-center w-responsive mx-auto mb-5">Do you have any suggestions or offers
                    for collaboration? Please do not hesitate to contact me directly.</p>

                <div class="row">


                    <div class="col-md-9 mb-md-0 mb-5">
                        <form id="contact-form" class="contact-form" action="AboutMeContact.php" method="POST">
